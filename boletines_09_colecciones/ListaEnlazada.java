...
public class ListaEnlazada<E> implements List<E> {
	...
	// El número de elementos que contiene actualmente la lista
	...
	protected class ListaEnlazadaIterator implements Iterator<E> {
		...
		public E next() {
			if (indice >= numElementos) {
				// Han llamado a next sin hacer antes hasNext y ya no había más elementos
				throw new NoSuchElementException();
			}
			
			// Si nunca se había llamado a next
			...
			// Movemos el índice por el que vamos recorriendo
			indice++;
		...
		public void remove() {
			...
			// El tamaño de la lista se ha reducido
			numElementos--;
			
			// Decrementamos también el índice que indica el elemento que iteramos
			indice--;
		}
